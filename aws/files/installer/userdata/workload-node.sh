    ...
    for i in $(seq 1 $MAX_RETRIES); do
        ...
        if aws s3 cp s3://cromwell-aws-cloudformation-templates/tes/amazon-ebs-autoscale.tgz /tmp/amazon-ebs-autoscale.tgz; then
            break
        fi
        sleep 15
    done
    ...
    ECR_EW1="391209680344.dkr.ecr.eu-west-1.amazonaws.com"
    ECR_EW2="391209680344.dkr.ecr.eu-west-2.amazonaws.com"
    T1=$(aws ecr get-login-password --region eu-west-1)
    T2=$(aws ecr get-login-password --region eu-west-2)
...
if [ -n "fs-0bd10f52a04211916" ]; then
        echo "Mounting EFS at /mnt/efs..."
        mkdir -p /mnt/efs
        mount -t nfs4 \
          -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport \
          fs-0bd10f52a04211916.efs.eu-west-2.amazonaws.com:/ /mnt/efs
        # persist across reboots
        echo "fs-0bd10f52a04211916.efs.eu-west-2.amazonaws.com:/ /mnt/efs nfs4 nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab
